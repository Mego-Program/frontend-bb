...
export default function EmployeeCard() {
    ...
    return (<>
        <div className="flex flex-col items-center pt-6 w-48 h-64 bg-slate-950 rounded-lg border border-amber-400 relative">
            ...
            <div className="text-center mt-4">
                <h3 className="text-amber-400 text-xl leading-4  font-medium capitalize ">Emma</h3>
                <h6 className="text-white text-sm font-normal capitalize leading-9">Web Developer</h6>
            </div>
